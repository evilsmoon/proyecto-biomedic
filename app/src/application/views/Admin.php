              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="number" class="form-control" min="1" max="10" value="3"></td>
                  </tr>
                  <tr>
                    <td rowspan="3">Analítico</td>
                    <td>Análisis del laboratorio</td>
                    <td><input type="number" class="form-control" min="1" max="10" value="10"></td>
                  </tr>
                  <tr>
                    <td>Accesorios del laboratorio</td>
                    <td><input type="number" class="form-control" min="1" max="10" value="2"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input type="number" class="form-control" min="1" max="10" value="1"></td>
                  </tr>
                </tbody>
              </table>
